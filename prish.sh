...
echo "Building Clean"
echo "==============="
make A50dd_defconfig O=A50
make -j$(nproc --all) O=A50
echo ""
echo "Kernel Compiled"
echo ""
cp -r ./A50/arch/arm64/boot/Image ./PRISH/AIK/split_img/boot.img-zImage
...
./zip.sh
cd ../..
cp -r ./PRISH/ZIP/1.zip ./output/PrishKernel-ONEUI-R3-A50dd.zip
cd output
echo ""
pwd
cd ..
...
rm ./PRISH/AIK/split_img/boot.img-zImage
rm ./output/Pri*
cp -r ./A50/arch/arm64/boot/Image ./output/Zimage/Image
cp -r ./A50/arch/arm64/boot/Image ./AIK/split_img/boot.img-zImage
./PRISH/AIK/repackimg.sh
cp -r ./PRISH/AIK/image-new.img ./PRISH/ZIP/PRISH/A50/boot.img
cd PRISH/ZIP
echo " "
...
./zip.sh
cd ../..
cp -r ./PRISH/AK/1*.zip ./output/PrishKernel-ONEUI-R3-Ak-A50dd.zip
cd output
cd ..
echo " "
pwd
